...
const CategoryPage = async ({ params }) => {
    ...
    return (
        <div className='flex flex-col items-center justify-center'>
            <div className='mx-3 md:mx-0 flex-col text-center gap-2 justify-center items-center'>
                <h1 className='font-semibold text-xl mt-10 px-5 py-3'>Explore our wide range of products in</h1>
