...
const Newsletter = () => {
    return (
        <main className="mx-2 md:mx-4 lg:mx-5 rounded-md bg-[url('/newsletter-bg-mb.jpg')] lg:bg-[url('/newsletter-bg.jpg')] bg-cover bg-center lg:bg-right-top mb-2 md:mb-4 lg:mb-5">
            <div className='flex flex-col items-center lg:items-end justify-center text-center gap-1 lg:gap-0 px-7 py-12 lg:px-5'>
                ...
                <div className='flex gap-2 my-6 relative'>
                    ...
                    <input className='bg-slate-300 text-black outline-none font-semibold rounded-md pl-10 md:pl-[43px] md:pr-28 py-3' type="email" placeholder="Enter your email ..." />
                ...
                <h3 className='opacity-50 leading-4 md:text-lg'>You will be able to unsubscribe at any time</h3>
            </div>
        </main>
    );
}
